...
class Library:
    ...
    def get_index_by_book_id(self, index_book=None) -> int:
        list = [i.id for i in self.books]
        if list.count(index_book) != 0:
            return list.index(index_book)
        else:
...
if __name__ == '__main__':
    ...
    print(library_with_books.get_index_by_book_id(4))  # проверяем индекс книги с id = 1
